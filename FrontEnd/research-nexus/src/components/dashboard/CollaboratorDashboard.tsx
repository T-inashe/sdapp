...
const CollaboratorDashboard: React.FC = () => {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      setIsLoading(true);
      try {
        // Fetch collaborator projects
        const projectResponse = await axios.get(`${config.API_URL}/api/collaborations`, {
        ...
        setNotifications([
          ...
          {
            id: '2',
            message: 'Your collaboration request for "Quantum Computing" was accepted',
            type: 'info',
            date: '2025-04-18'
          },
          {
            id: '3',
            message: 'New skills match: 3 projects require your expertise',
            type: 'info',
            date: '2025-04-17'
          }
        ]);
  ...
  const handleApply = (opportunityId: number) => {
    // In production, this would send an application to the API
        ...
        <div className="dashboard-header">
          ...
          <div>
            <Link to="/profile/skills">
              <Button variant="primary" className="me-2">Update Skills Profile</Button>
            </Link>
