    ...
    <Container className="messages-container">
      ...
      {invites.length === 0 ? (
        ...
        invites.map((invite) => {
          ...
          return (
            <Card key={invite._id}  onClick={() => goToChat(invite.project._id)}className="message-card">
              <Card.Body>
                ...
                {invite.status === 'Pending' ? (
                  ...
                  <div className="accepted-label text-success mt-2">
                    ✅ Welcome to the team! Please wait for further communication from the
                    creator.
                  </div>
                ) : (
